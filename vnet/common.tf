...
locals {
  master_subnet_cidr_v4 = !var.preexisting_network && var.use_ipv4 ? cidrsubnet(var.vnet_v4_cidrs[0], 8, 1) : null  #master subnet is a smaller subnet within the vnet. i.e from /21 to /24
  master_subnet_cidr_v6 = !var.preexisting_network && var.use_ipv6 ? cidrsubnet(var.vnet_v6_cidrs[0], 16, 1) : null #master subnet is a smaller subnet within the vnet. i.e from /48 to /64

  worker_subnet_cidr_v4 = !var.preexisting_network && var.use_ipv4 ? cidrsubnet(var.vnet_v4_cidrs[0], 8, 2) : null  #node subnet is a smaller subnet within the vnet. i.e from /21 to /24
  worker_subnet_cidr_v6 = !var.preexisting_network && var.use_ipv6 ? cidrsubnet(var.vnet_v6_cidrs[0], 16, 2) : null #node subnet is a smaller subnet within the vnet. i.e from /48 to /64
