locals {
  ...
  rhcos_image             = var.rhcos_image != "" ? var.rhcos_image : (local.ocp_v4_10_plus ?  data.external.vhd_location[0].result["VHD_URL"] : lookup(lookup(jsondecode(data.http.images[0].body), "azure"), "url"))
}
